...
.chat-room{{background:#070b12;padding:16px;height:{chat_h}px;overflow-y:auto;display:flex;flex-direction:column;gap:12px;scrollbar-width:thin;scrollbar-color:#1e293b transparent;}}
...
def render_chat():
    html, chat_h = build_chat_html(search_q)
    chat_placeholder.empty()
    with chat_placeholder.container():
        components.html(html, height=chat_h + 20, scrolling=False)
